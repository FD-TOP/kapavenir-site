...
const packs = [
  ...
  },
  {
    ...
    features: [
      'Diagnostic retraite approfondi',
      'Reconstitution complète de carrière tous régimes',
      'Identification et traitement des anomalies',
      'Échanges avec les caisses de retraite',
      'Optimisation de votre stratégie de départ',
      'Constitution complète du dossier retraite',
      'Suivi administratif et relances',
      'Accompagnement personnalisé jusqu’au dépôt du dossier',
    ],
  },
  {
    id: 'prestige',
    ...
    features: [
      ...
      'Optimisation fine du départ à la retraite',
      'Accompagnement au rachat de trimestres',
      'Conseils cumul emploi-retraite',
      'Support prioritaire et illimité',
      'Accompagnement physique selon zone',
      'Gestion complète jusqu’à liquidation des droits',
      'Assistance post-départ à la retraite',
    ],
  },
];
